    ...
    return (
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-2xl max-w-md w-full p-8 text-center shadow-2xl">
          ...
          <p className="text-gray-500">Tu plan {planType === 'player' ? 'Player' : 'Team'} esta activo</p>
        </div>
      </div>
    );
  }
      ...
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl">
          ...
          <div className="text-center py-6">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Pago con tarjeta</h2>
      ...
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl relative">
          ...
          <div className="flex flex-col items-center space-y-4">
            <h2 className="text-xl font-bold text-gray-900">Pagar con Lightning</h2>
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl relative">
        ...
        <div className="text-center mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-1">Elige como pagar</h2>
          <p className="text-sm text-gray-500">{description}</p>
          <p className="text-2xl font-bold text-gray-900 mt-2">{amount} sats</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="text-left flex-1">
              <p className="font-semibold text-gray-900">Bitcoin Lightning</p>
              <p className="text-xs text-gray-500">Pago instantaneo con tu wallet</p>
            </div>
            {state === 'processing' && (
          ...
          >
            ...
            <div className="text-left flex-1">
              <p className="font-semibold text-gray-900">Tarjeta (Stripe)</p>
