/*
  # Fix La Paliza - Resolve Column Ambiguity

  1. Changes
    - Fix column reference ambiguity in `get_la_paliza` function
    - Use table aliases to disambiguate `course_name` references
    - No logic changes, just fixing SQL syntax error
*/
