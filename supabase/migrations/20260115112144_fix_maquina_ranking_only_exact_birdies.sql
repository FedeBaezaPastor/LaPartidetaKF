/*
  # Fix Máquina Ranking - Count Only Exact Birdies

  1. Changes
    - Update get_maquina_ranking to count ONLY exact birdies (net_strokes = par - 1)
    - Previously counted all scores <= par - 1 (including eagles, albatros)
    - Now counts ONLY birdies, not eagles or better
*/
