/*
  # Add Total Holes Count to Player Statistics

  1. Changes
    - Update get_detailed_player_statistics function to include total holes played count
    - This helps users understand the sample size for hole results distribution

  2. Notes
    - Counts total holes from hole_scores data
    - Returns 0 if no hole scores available
*/
