...
- Pendiente: publicar el frontend actualizado si el usuario desea activar la función en la web de producción. No se ha desplegado en el VPS; el contenedor existente está activo. El chat recuperado no contiene una instrucción explícita de publicación.
